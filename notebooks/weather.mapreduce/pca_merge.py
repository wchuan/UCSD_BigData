    ...
    def reducer_pre(self, station_pair, weathers):
        ...
        if data_count == 2 and len(weather_max) == 365 and len(weather_min) == 365:
            ...
            if valid_count >= 180:
                ...
                region = station_pair[2]
                yield region[:-1], weather_data
